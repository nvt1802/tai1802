...
const SetingLanguageForm = () => {
  ...
  const [selectedValue, setSelectedValue] = useState(localStorage.getItem('lng') || 'vn')
  ...
  return (
    <Fragment>
      <FormControl>
        <RadioGroup aria-label="language" name="language" value={selectedValue} onChange={handleChangeLanguage}>
